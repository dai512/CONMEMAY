...
/*
 ĐẠI DoS tool on <strike>steroids</strike> goroutines. Just ported from Python with some improvements.
 Original Python utility by Barry Shteiman http://www.sex.com/2012/05/17/

 This go program licensed under GPLv3.
 Copyright Alexander I.Grafov <@gmail.com>
*/
...
func main() {
	...
	go func() {
		fmt.Println("                -- Đại DDOS Start --\n                     Bắt Đầu!\n\n")
		ss := make(chan uint8, 8)
		var (
			err, sent int32
		)
		fmt.Println("      Đang Dùng      |\tĐã Đập  |\tLỗi Đập")
		for {
